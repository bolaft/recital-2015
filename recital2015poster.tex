...
\setbackgrounddarkcolor{gray!100!}
% \setbackgroundlightcolor{gray!10!}
...
\title{État de l’art : analyse des conversations écrites en ligne porteuses de demandes
d’assistance en termes d’actes de dialogue}
\author{Soufian Salim\\
  LINA UMR 6241 - Université de Nantes, 2 rue de la houssinière, 44 322 Nantes Cedec 03\\
  \texttt{soufian.salim@univ-nantes.fr}
}
